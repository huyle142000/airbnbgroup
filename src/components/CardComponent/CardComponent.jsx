    ...
    > 
      ...
      <div className='card_content'>
          <div className='card_name'>
              <div className='card_name_text'>{tenPhong.length > 50 ? tenPhong.substring(0, 50) + "..." : tenPhong }</div>
