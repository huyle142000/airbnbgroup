        ...
        >
          <div className="header__border">
            ...
            <span className="search__display">
              <button className="btn--def btn--right">Add guests</button>
          ...
          <div className="region__container">
            <div className="region__content">
              ...
              <Row gutter={[16, 16]}>
                ...
                <Col span={8}>
                  <img className="img-fluid" src={eu} alt="" />
                  <div className="area">Europe</div>
                </Col>
                <Col span={8}>
                  <img className="img-fluid" src={tl} alt="" />
                  <div className="area">Thailand</div>
                </Col>
                <Col span={8}>
                  <img className="img-fluid" src={aus} alt="" />
                  <div className="area">Australia</div>
                </Col>
                <Col span={8}>
                  <img className="img-fluid" src={sk} alt="" />
                  <div className="area">South Korea</div>
                </Col>
                <Col span={8}>
                  <img className="img-fluid" src={us} alt="" />
