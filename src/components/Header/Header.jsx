            ...
            return (
                ...
                >
                    <div className="header__border">
                        ...
                        <button className="btn--def btn--middle">
                            Any week
                        </button>
                        <span className="dot"></span>
                        <span className="search__display">
                            <button className="btn--def btn--right">
                                Add guests
                            </button>
                ...
                <div className="form__flex">
                    ...
                    >
                        <div className="search--flex">
                            ...
                            <NavLink
                                to={`room-filter/region=${region}&checkin=${moment(
                                    checkDateIn
                                ).format("MMM DD yyyy")}&checkout=${moment(
                                    checkDateOut
                                ).format("MMM DD yyyy")}&guest=${totalGuest}`}
                            >
