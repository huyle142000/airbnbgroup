...
export default function ConfirmPay() {
  ...
  return (
    <>
      ...
      <div className="container-lg request_book pb-3">
        <div>
          <h2>
            <span>
              <i
        ...
        <div className="row">
          <div className="col-7">
            <div className="request_tag border_around-thin">
              <h6>Good price.</h6>
              <p>
                Your dates are £62 less than the avg. nightly rate over the last
                3 months.
              </p>
              <i className="fa-solid fa-tag"></i>
            </div>
            <div className="request_trip border_bottom">
              <h6>Your trip</h6>
            ...
            <div className="request_pay border_bottom request_padding">
              ...
              <div className="request_pay-code border-bottom request_padding">
                <div className="request_pay-number request_pay-card border_around-medium">
                  <input type="text" />
                  <span>Card number</span>
                </div>
                <div className="request_pay-zip request_pay-card border_around-medium">
                  <input type="text" />
                  <span>ZIP Code</span>
                </div>
              </div>
              <div className="request_pay-cancel border-bottom request_padding">
                <h6>Cancellation policy</h6>
                <p>This reservation is non-refundable.</p>
              </div>
              <div className="request_pay-rules border-bottom request_padding">
                <h6>Ground rules</h6>
                <p>
            ...
            <div className="accept_rules">
              <span>
                Host's House Rules , Ground rules for guests, Airbnb's Rebooking
                and Refund Policy , and that Airbnb can charge my payment
                methodif I’m responsible for damage. I agree to pay the total
